        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 mb-12">
          {socialLinks.map((link, index) => (
            <motion.a
              ...
              className="flex flex-col items-center p-6 bg-card rounded-xl border border-border transition-all duration-300 hover:border-primary group"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <motion.div
                className="w-12 h-12 bg-primary/20 rounded-lg flex items-center justify-center mb-3 group-hover:bg-primary/30 transition-colors"
                whileHover={{ rotate: 5 }}
              >
