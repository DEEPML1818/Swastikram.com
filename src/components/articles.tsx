          ...
          {articles.map((article, index) => (
            ...
            >
              <a 
                ...
                className="block p-6 md:p-8 glass-card rounded-2xl border-black/[0.05] hover:border-black/[0.12] transition-all duration-300 hover:shadow-[0_20px_50px_rgba(0,0,0,0.04)] overflow-hidden"
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                   <div className="flex-grow">
                      <div className="flex items-center gap-3.5 mb-4 text-xs font-semibold tracking-wide text-foreground/45">
                      ...
                      <h3 className="text-xl md:text-2xl font-bold text-foreground tracking-tight mb-3 group-hover:text-accent transition-colors leading-tight">
                         {article.title}
                      </h3>
                      
                      <p className="text-foreground/65 mb-6 max-w-3xl leading-relaxed text-sm font-normal line-clamp-2">
                        {article.description}
                      </p>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {article.tags.map((tag, tIdx) => (
                          <span 
                            key={tIdx}
                            className="px-2.5 py-1 rounded-lg bg-black/[0.03] border border-black/[0.08] text-[10px] font-medium text-foreground/50"
                          >
                            {tag}
                          </span>
                        ))}
                   ...
                   <div className="flex items-center md:border-l border-black/[0.06] md:pl-10">
                      <div className="w-10 h-10 rounded-xl bg-black/[0.03] border border-black/[0.08] flex items-center justify-center text-foreground/50 group-hover:bg-accent/25 group-hover:border-accent/40 group-hover:text-accent transition-all duration-300">
